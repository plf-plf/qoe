...
class MLSTMfcn(nn.Module):
    def __init__(self, *, num_classes, max_seq_len, num_features,
        ...
        self.conv1 = nn.Conv1d(self.num_features, self.conv1_nf, 8) #[num_features,128,8]
        self.conv2 = nn.Conv1d(self.conv1_nf, self.conv2_nf, 5) #[128,256,5]
        self.conv3 = nn.Conv1d(self.conv2_nf, self.conv3_nf, 3) #[256,128,3]
