...
# 如果当前轮次的验证损失比之前的最小验证损失更小，就保存当前模型，并更新最小验证损失。
# 这是一种常见的做法，用于保存性能最好的模型。
...
if __name__ == '__main__':
    ...
    print('input_size:',input_size,'output_size:',output_size,'timestep:',timestep)
    for i in batch_size:
        ...
        if type_train:
            ...
            model = torch.load(f'/opt/data/private/ljx/plf/qos_mi/output/all_online/epoch=400/TCAN_online/online_model_128.pth')
